...
\item \textbf{Geometric ergodicity conjecture:}
While \cref{thm:uas} establishes positive Harris recurrence, the Foster--Lyapunov framework admits extensions to geometric ergodicity given standard geometric drift and minorization conditions. Under the mild additional requirement of uniform petite sets on compact state spaces, we conjecture that this underlying bounded structure may support exponential mixing rates towards stationarity. This remains an open, speculative question that is essential for deployment in production server loops.
\end{enumerate}
