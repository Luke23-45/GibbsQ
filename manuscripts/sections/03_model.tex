...
The raw softmax theorem (\cref{sec:softmax_theorem}), the UAS theorem (\cref{sec:uas_theorem}), and the certified-subset calibrated theorem in Section~\ref{sec:calibrated_uas} each verify \cref{eq:foster_lyapunov} with explicit Lyapunov functions and closed-form constants~$\varepsilon$ and~$R$.
