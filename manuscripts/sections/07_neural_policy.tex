...
A feedforward network with two hidden layers and ReLU activations produces logits, passed through a softmax to yield
\begin{equation}
...
Training runs for 1{,}000 steps, reaching 97--99\% top-1 accuracy, providing a stable initialization for Phase~2.
