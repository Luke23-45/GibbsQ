...
The network is trained via cross-entropy loss against an analytical teacher policy (UAS with $\temp = 10$ by default; the ablation in \cref{sec:exp:ablation} also evaluates Reflected UAS).
