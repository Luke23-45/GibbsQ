...
from gibbsq.qroute.engines.jax_ssa import vmap_collect_trajectories, compute_poisson_max_steps
from gibbsq.qroute.core.reinforce_objective import extract_first_action_returns_jax
...
def compute_reinforce_gradient(
    ...
    import numpy as np
    import equinox as eqx
    from gibbsq.qroute.engines.jax_ssa import vmap_collect_trajectories
...
def run_gradient_check(
    ...
    alpha = 0.05
    base_test = 50  # Baseline dimensionality tuned safely at base_samples
...
def main(raw_cfg: DictConfig) -> None:
    ...
    from gibbsq.qroute.analysis.plotting import plot_gradient_scatter
