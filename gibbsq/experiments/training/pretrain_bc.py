"""
Unified behavior-cloning pretraining for the active z2 neural-support path.

This is the canonical BC entrypoint used by the current experiment suite.
It prepares a self-contained neural policy checkpoint for the H7 supporting
...
from gibbsq.qroute.core.pretraining import extract_bc_data_config, train_robust_bc_policy
from gibbsq.qroute.utils.logging import setup_wandb, get_run_config
from gibbsq.qroute.utils.model_io import BC_POINTER, save_model_pointer, write_bc_reuse_metadata
from gibbsq.qroute.utils.run_artifacts import artifacts_dir
...
def main(raw_cfg: DictConfig):
    ...
    model_path = artifacts / "n_gibbsq_platinum_bc_weights.eqx"
