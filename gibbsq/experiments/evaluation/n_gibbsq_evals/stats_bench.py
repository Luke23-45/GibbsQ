...
from gibbsq.qroute.engines.jax_ssa import compute_poisson_max_steps
from gibbsq.qroute.engines.numpy_engine import run_replications, simulate
...
class StatsBenchmark:
    ...
    def execute(self, key: PRNGKeyArray):
        ...
        from gibbsq.qroute.utils.model_io import validate_neural_model_shape
        ...
        # NOTE: The Reflected UAS baseline requires alpha=20.0, matching the
        ...
        append_metrics_jsonl(
            {
                ...
                "reflected_uas_mean": float(b_mean),
                "reflected_uas_std": float(b_std),
