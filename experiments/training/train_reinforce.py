...
class ReinforceTrainer:
    ...
    def execute(self, key: PRNGKeyArray, n_epochs: int = 100):
        ...
        # PI-V4.3: Refined Global Norm Clipping (User Optimized: 5.0)
            ...
            if len(batch_G) > 0:
                ...
                def policy_loss_fn(model, s_feat, rho_feat, actions, advs, traj_indices, ent_coef):
                    ...
                    def explained_variance(y_true, y_pred):
                        ...
                        return ev
                    ev = explained_variance(advs + v_preds, v_preds)
                ...
                (policy_loss, policy_aux), policy_grads = eqx.filter_value_and_grad(policy_loss_fn, has_aux=True)(
                    policy_net, s_feat, rho_tensor, A_tensor, norm_adv, idx_tensor, self.cfg.neural.entropy_bonus
                )
                ...
                def value_loss_fn(model, s_feat, rho_feat, returns_to_go):
