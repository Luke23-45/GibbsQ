...
def sharded_replications(
    ...
    # 3. Execute! JAX will automatically orchestrate the distributed execution
    # according to the SPMD (Single Program Multiple Data) pattern because
    # inputs are explicitly sharded via device_put.
