...
vector-graphic ready output, and scientifically rigorous axis labeling.
"""
...
from moeq.core.drift import DriftResult
from moeq.analysis.metrics import running_average, total_queue_trajectory
...
def _apply_theme() -> None:
    """Set rigorous, publication-ready dark theme."""
